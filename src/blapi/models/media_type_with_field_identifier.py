...
class MediaTypeWithFieldIdentifier(object):
    ...
    swagger_types = {
        ...
        'field_identifier_type': 'str'
    }

    attribute_map = {
        'type': '@type',
        'output_media_type': 'outputMediaType',
        'field_identifier_type': 'fieldIdentifierType'
    }

    def __init__(self, type=None, output_media_type=None, field_identifier_type=None):  # noqa: E501
        """MediaTypeWithFieldIdentifier - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._output_media_type = None
        self._field_identifier_type = None
        self.discriminator = None
        self.type = type
        self.output_media_type = output_media_type
        if field_identifier_type is not None:
            self.field_identifier_type = field_identifier_type

    @property
    def type(self):
        """Gets the type of this MediaTypeWithFieldIdentifier.  # noqa: E501


        :return: The type of this MediaTypeWithFieldIdentifier.  # noqa: E501
        :rtype: AllOfMediaTypeWithFieldIdentifierType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this MediaTypeWithFieldIdentifier.


        :param type: The type of this MediaTypeWithFieldIdentifier.  # noqa: E501
        :type: AllOfMediaTypeWithFieldIdentifierType
        """
        if type is None:
    ...
    def output_media_type(self):
        """Gets the output_media_type of this MediaTypeWithFieldIdentifier.  # noqa: E501

        Use the mediaType to request custom datasets in [CSV](https://www.ietf.org/rfc/rfc4180.txt) or [JSON](https://www.ietf.org/rfc/rfc8259.txt) format. CSV output from DL REST API is normalised to [XSD 1.1 types](https://www.w3.org/TR/xmlschema11-2/) such as xsd:boolean and xsd:date to facilitate ingestion.  # noqa: E501

        :return: The output_media_type of this MediaTypeWithFieldIdentifier.  # noqa: E501
        :rtype: str
        """
        return self._output_media_type

    @output_media_type.setter
    def output_media_type(self, output_media_type):
        """Sets the output_media_type of this MediaTypeWithFieldIdentifier.

        Use the mediaType to request custom datasets in [CSV](https://www.ietf.org/rfc/rfc4180.txt) or [JSON](https://www.ietf.org/rfc/rfc8259.txt) format. CSV output from DL REST API is normalised to [XSD 1.1 types](https://www.w3.org/TR/xmlschema11-2/) such as xsd:boolean and xsd:date to facilitate ingestion.  # noqa: E501

        :param output_media_type: The output_media_type of this MediaTypeWithFieldIdentifier.  # noqa: E501
        :type: str
        """
        if output_media_type is None:
            raise ValueError("Invalid value for `output_media_type`, must not be `None`")  # noqa: E501
        allowed_values = ["text/csv", "application/json"]  # noqa: E501
        if output_media_type not in allowed_values:
            raise ValueError(
                "Invalid value for `output_media_type` ({0}), must be one of {1}"  # noqa: E501
                .format(output_media_type, allowed_values)
            )

        self._output_media_type = output_media_type

    @property
    def field_identifier_type(self):
        """Gets the field_identifier_type of this MediaTypeWithFieldIdentifier.  # noqa: E501

        Only valid if `outputMediaType` is set to `\"text/csv\"`. The identifier used for fields used in the returned CSV file. The default type depends on your account permissions.  # noqa: E501

        :return: The field_identifier_type of this MediaTypeWithFieldIdentifier.  # noqa: E501
        :rtype: str
        """
        return self._field_identifier_type

    @field_identifier_type.setter
    def field_identifier_type(self, field_identifier_type):
        """Sets the field_identifier_type of this MediaTypeWithFieldIdentifier.

        Only valid if `outputMediaType` is set to `\"text/csv\"`. The identifier used for fields used in the returned CSV file. The default type depends on your account permissions.  # noqa: E501

        :param field_identifier_type: The field_identifier_type of this MediaTypeWithFieldIdentifier.  # noqa: E501
        :type: str
        """
        allowed_values = ["cleanName", "mnemonic"]  # noqa: E501
        if field_identifier_type not in allowed_values:
            raise ValueError(
                "Invalid value for `field_identifier_type` ({0}), must be one of {1}"  # noqa: E501
                .format(field_identifier_type, allowed_values)
            )

        self._field_identifier_type = field_identifier_type
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MediaTypeWithFieldIdentifier, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MediaTypeWithFieldIdentifier):
            return False
