...
class PricingSourceDetail(object):
    ...
    def __init__(self, mnemonic=None):  # noqa: E501
        """PricingSourceDetail - a model defined in Swagger"""  # noqa: E501
        self._mnemonic = None
    ...
    @property
    def mnemonic(self):
        """Gets the mnemonic of this PricingSourceDetail.  # noqa: E501

        The mnemonic of the specified pricing source (e.g. `BGN`, `EXCH`, `CMPN`).  # noqa: E501

        :return: The mnemonic of this PricingSourceDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def mnemonic(self, mnemonic):
        """Sets the mnemonic of this PricingSourceDetail.

        The mnemonic of the specified pricing source (e.g. `BGN`, `EXCH`, `CMPN`).  # noqa: E501

        :param mnemonic: The mnemonic of this PricingSourceDetail.  # noqa: E501
        :type: str
        """
        if mnemonic is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PricingSourceDetail, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PricingSourceDetail):
            return False
