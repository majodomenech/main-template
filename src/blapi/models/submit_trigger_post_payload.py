...
class SubmitTriggerPostPayload(object):
    ...
    def __init__(self, type=None):  # noqa: E501
        """SubmitTriggerPostPayload - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this SubmitTriggerPostPayload.  # noqa: E501

        Run the request upon request submission.  # noqa: E501

        :return: The type of this SubmitTriggerPostPayload.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SubmitTriggerPostPayload.

        Run the request upon request submission.  # noqa: E501

        :param type: The type of this SubmitTriggerPostPayload.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["SubmitTrigger"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubmitTriggerPostPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubmitTriggerPostPayload):
            return False
