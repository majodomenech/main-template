...
import six
from blapi.models.field_list import FieldList  # noqa: F401,E501

class DeletedFieldList(FieldList):
    ...
    if hasattr(FieldList, "swagger_types"):
        swagger_types.update(FieldList.swagger_types)

    attribute_map = {
        'deleted_on': 'deletedOn'
    }
    if hasattr(FieldList, "attribute_map"):
        attribute_map.update(FieldList.attribute_map)

    def __init__(self, deleted_on=None, *args, **kwargs):  # noqa: E501
        """DeletedFieldList - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def deleted_on(self):
        """Gets the deleted_on of this DeletedFieldList.  # noqa: E501


        :return: The deleted_on of this DeletedFieldList.  # noqa: E501
        :rtype: DeletedOn
        """
    ...
    def deleted_on(self, deleted_on):
        """Sets the deleted_on of this DeletedFieldList.


        :param deleted_on: The deleted_on of this DeletedFieldList.  # noqa: E501
        :type: DeletedOn
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedFieldList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedFieldList):
            return False
