...
class RequestUniversePatch(object):
    ...
    def __init__(self, contains=None):  # noqa: E501
        """RequestUniversePatch - a model defined in Swagger"""  # noqa: E501
        self._contains = None
    ...
    @property
    def contains(self):
        """Gets the contains of this RequestUniversePatch.  # noqa: E501


        :return: The contains of this RequestUniversePatch.  # noqa: E501
    ...
    def contains(self, contains):
        """Sets the contains of this RequestUniversePatch.


        :param contains: The contains of this RequestUniversePatch.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RequestUniversePatch, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestUniversePatch):
            return False
