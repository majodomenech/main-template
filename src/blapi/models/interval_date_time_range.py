...
class IntervalDateTimeRange(object):
    ...
    def __init__(self, type=None, start_date_time=None, end_date_time=None):  # noqa: E501
        """IntervalDateTimeRange - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this IntervalDateTimeRange.  # noqa: E501


        :return: The type of this IntervalDateTimeRange.  # noqa: E501
        :rtype: AllOfIntervalDateTimeRangeType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this IntervalDateTimeRange.


        :param type: The type of this IntervalDateTimeRange.  # noqa: E501
        :type: AllOfIntervalDateTimeRangeType
        """
        if type is None:
    ...
    def start_date_time(self):
        """Gets the start_date_time of this IntervalDateTimeRange.  # noqa: E501

        The start of the datetime range, inclusive, in ISO format (YYYY-MM-DDThh:mm:ssZ). The timezone of this datetime value is required to be UTC, denoted by the `Z` at the end.  # noqa: E501

        :return: The start_date_time of this IntervalDateTimeRange.  # noqa: E501
        :rtype: str
        """
    ...
    def start_date_time(self, start_date_time):
        """Sets the start_date_time of this IntervalDateTimeRange.

        The start of the datetime range, inclusive, in ISO format (YYYY-MM-DDThh:mm:ssZ). The timezone of this datetime value is required to be UTC, denoted by the `Z` at the end.  # noqa: E501

        :param start_date_time: The start_date_time of this IntervalDateTimeRange.  # noqa: E501
        :type: str
        """
    ...
    def end_date_time(self):
        """Gets the end_date_time of this IntervalDateTimeRange.  # noqa: E501

        The end of the datetime range, inclusive, in ISO format (YYYY-MM-DDThh:mm:ssZ). The timezone of this datetime value is required to be UTC, denoted by the `Z` at the end.  # noqa: E501

        :return: The end_date_time of this IntervalDateTimeRange.  # noqa: E501
        :rtype: str
        """
    ...
    def end_date_time(self, end_date_time):
        """Sets the end_date_time of this IntervalDateTimeRange.

        The end of the datetime range, inclusive, in ISO format (YYYY-MM-DDThh:mm:ssZ). The timezone of this datetime value is required to be UTC, denoted by the `Z` at the end.  # noqa: E501

        :param end_date_time: The end_date_time of this IntervalDateTimeRange.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IntervalDateTimeRange, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IntervalDateTimeRange):
            return False
