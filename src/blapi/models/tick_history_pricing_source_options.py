...
class TickHistoryPricingSourceOptions(BasePricingSourceOptions):
    ...
    def __init__(self, type=None, *args, **kwargs):  # noqa: E501
        """TickHistoryPricingSourceOptions - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this TickHistoryPricingSourceOptions.  # noqa: E501


        :return: The type of this TickHistoryPricingSourceOptions.  # noqa: E501
        :rtype: object
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TickHistoryPricingSourceOptions.


        :param type: The type of this TickHistoryPricingSourceOptions.  # noqa: E501
        :type: object
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TickHistoryPricingSourceOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TickHistoryPricingSourceOptions):
            return False
