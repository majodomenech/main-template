...
import six
from blapi.models.base_pricing_source_options import BasePricingSourceOptions  # noqa: F401,E501

class DataPricingSourceOptions(BasePricingSourceOptions):
    ...
    swagger_types = {
        'type': 'object',
        'skip': 'PricingSourceSkipDetails'
    }
    if hasattr(BasePricingSourceOptions, "swagger_types"):
        swagger_types.update(BasePricingSourceOptions.swagger_types)

    attribute_map = {
        'type': '@type',
        'skip': 'skip'
    }
    if hasattr(BasePricingSourceOptions, "attribute_map"):
        attribute_map.update(BasePricingSourceOptions.attribute_map)

    def __init__(self, type=None, skip=None, *args, **kwargs):  # noqa: E501
        """DataPricingSourceOptions - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._skip = None
        ...
        if skip is not None:
            self.skip = skip
        BasePricingSourceOptions.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this DataPricingSourceOptions.  # noqa: E501


        :return: The type of this DataPricingSourceOptions.  # noqa: E501
        :rtype: object
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DataPricingSourceOptions.


        :param type: The type of this DataPricingSourceOptions.  # noqa: E501
        :type: object
        """
        if type is None:
    ...
    @property
    def skip(self):
        """Gets the skip of this DataPricingSourceOptions.  # noqa: E501


        :return: The skip of this DataPricingSourceOptions.  # noqa: E501
        :rtype: PricingSourceSkipDetails
        """
        return self._skip

    @skip.setter
    def skip(self, skip):
        """Sets the skip of this DataPricingSourceOptions.


        :param skip: The skip of this DataPricingSourceOptions.  # noqa: E501
        :type: PricingSourceSkipDetails
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DataPricingSourceOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataPricingSourceOptions):
            return False
