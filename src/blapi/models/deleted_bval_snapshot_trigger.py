...
import six
from blapi.models.bval_snapshot_trigger import BvalSnapshotTrigger  # noqa: F401,E501

class DeletedBvalSnapshotTrigger(BvalSnapshotTrigger):
    ...
    if hasattr(BvalSnapshotTrigger, "swagger_types"):
        swagger_types.update(BvalSnapshotTrigger.swagger_types)

    attribute_map = {
        'deleted_on': 'deletedOn'
    }
    if hasattr(BvalSnapshotTrigger, "attribute_map"):
        attribute_map.update(BvalSnapshotTrigger.attribute_map)

    def __init__(self, deleted_on=None, *args, **kwargs):  # noqa: E501
        """DeletedBvalSnapshotTrigger - a model defined in Swagger"""  # noqa: E501
        self._deleted_on = None
        self.discriminator = None
        self.deleted_on = deleted_on
        BvalSnapshotTrigger.__init__(self, *args, **kwargs)

    @property
    def deleted_on(self):
        """Gets the deleted_on of this DeletedBvalSnapshotTrigger.  # noqa: E501


        :return: The deleted_on of this DeletedBvalSnapshotTrigger.  # noqa: E501
        :rtype: DeletedOn
        """
    ...
    def deleted_on(self, deleted_on):
        """Sets the deleted_on of this DeletedBvalSnapshotTrigger.


        :param deleted_on: The deleted_on of this DeletedBvalSnapshotTrigger.  # noqa: E501
        :type: DeletedOn
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedBvalSnapshotTrigger, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedBvalSnapshotTrigger):
            return False
