...
class ActionsRuntimeOptions(object):
    ...
    swagger_types = {
        ...
        'date_range': 'OneOfActionsRuntimeOptionsDateRange',
        'actions_date': 'str'
    }
    ...
    attribute_map = {
        ...
        'actions_date': 'actionsDate'
    }

    def __init__(self, type=None, date_range=None, actions_date='entry'):  # noqa: E501
        """ActionsRuntimeOptions - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._date_range = None
        self._actions_date = None
        self.discriminator = None
        self.type = type
        if date_range is not None:
            self.date_range = date_range
        if actions_date is not None:
            self.actions_date = actions_date

    @property
    def type(self):
        """Gets the type of this ActionsRuntimeOptions.  # noqa: E501


        :return: The type of this ActionsRuntimeOptions.  # noqa: E501
        :rtype: AllOfActionsRuntimeOptionsType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this ActionsRuntimeOptions.


        :param type: The type of this ActionsRuntimeOptions.  # noqa: E501
        :type: AllOfActionsRuntimeOptionsType
        """
        if type is None:
    ...
    @property
    def date_range(self):
        """Gets the date_range of this ActionsRuntimeOptions.  # noqa: E501

        This property specifies the date range across which the request will search for corporate actions. Any `ActionsRequest` that references a recurring `ScheduledTrigger` (where the frequency is \"daily\" \"weekday\" \"weekend\" \"weekly\" or \"monthly\") may only specify a `ActionsDurationDateRange`, ensuring the date range remains relative to each execution of the request. An `ActionsRequest` that references a trigger which will only execute once (a `ScheduledTrigger` with a frequency of \"once\" or a `SubmitTrigger`) can also specify a date range using literal dates using an `IntervalDateRange`. If this property is not supplied, the range will default to an `ActionsDurationDateRange` with 0 `days`.  # noqa: E501

        :return: The date_range of this ActionsRuntimeOptions.  # noqa: E501
        :rtype: OneOfActionsRuntimeOptionsDateRange
        """
        return self._date_range

    @date_range.setter
    def date_range(self, date_range):
        """Sets the date_range of this ActionsRuntimeOptions.

        This property specifies the date range across which the request will search for corporate actions. Any `ActionsRequest` that references a recurring `ScheduledTrigger` (where the frequency is \"daily\" \"weekday\" \"weekend\" \"weekly\" or \"monthly\") may only specify a `ActionsDurationDateRange`, ensuring the date range remains relative to each execution of the request. An `ActionsRequest` that references a trigger which will only execute once (a `ScheduledTrigger` with a frequency of \"once\" or a `SubmitTrigger`) can also specify a date range using literal dates using an `IntervalDateRange`. If this property is not supplied, the range will default to an `ActionsDurationDateRange` with 0 `days`.  # noqa: E501

        :param date_range: The date_range of this ActionsRuntimeOptions.  # noqa: E501
        :type: OneOfActionsRuntimeOptionsDateRange
        """

        self._date_range = date_range

    @property
    def actions_date(self):
        """Gets the actions_date of this ActionsRuntimeOptions.  # noqa: E501

        Apply the specified dateRange to the date the action was recorded by Bloomberg (`entry`), the date as of which the action is effective (`effective`) or either (`both`).  # noqa: E501

        :return: The actions_date of this ActionsRuntimeOptions.  # noqa: E501
        :rtype: str
        """
        return self._actions_date

    @actions_date.setter
    def actions_date(self, actions_date):
        """Sets the actions_date of this ActionsRuntimeOptions.

        Apply the specified dateRange to the date the action was recorded by Bloomberg (`entry`), the date as of which the action is effective (`effective`) or either (`both`).  # noqa: E501

        :param actions_date: The actions_date of this ActionsRuntimeOptions.  # noqa: E501
        :type: str
        """
        allowed_values = ["both", "effective", "entry"]  # noqa: E501
        if actions_date not in allowed_values:
            raise ValueError(
                "Invalid value for `actions_date` ({0}), must be one of {1}"  # noqa: E501
                .format(actions_date, allowed_values)
            )

        self._actions_date = actions_date
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ActionsRuntimeOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActionsRuntimeOptions):
            return False
