...
class BbaTerminalIdentity(object):
    ...
    def __init__(self, type=None, user_number=None):  # noqa: E501
        """BbaTerminalIdentity - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this BbaTerminalIdentity.  # noqa: E501

        A BBA (Bloomberg Anywhere) user account, specified by `userNumber` only.  # noqa: E501

        :return: The type of this BbaTerminalIdentity.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this BbaTerminalIdentity.

        A BBA (Bloomberg Anywhere) user account, specified by `userNumber` only.  # noqa: E501

        :param type: The type of this BbaTerminalIdentity.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["BbaTerminalIdentity"]  # noqa: E501
    ...
    def user_number(self):
        """Gets the user_number of this BbaTerminalIdentity.  # noqa: E501


        :return: The user_number of this BbaTerminalIdentity.  # noqa: E501
        :rtype: UserNumber
        """
    ...
    def user_number(self, user_number):
        """Sets the user_number of this BbaTerminalIdentity.


        :param user_number: The user_number of this BbaTerminalIdentity.  # noqa: E501
        :type: UserNumber
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BbaTerminalIdentity, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BbaTerminalIdentity):
            return False
