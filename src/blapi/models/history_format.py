...
class HistoryFormat(BaseFormat):
    ...
    attribute_map = {
        'type': '@type',
        'date_format': 'dateFormat',
        'display_pricing_source': 'displayPricingSource'
    }
    if hasattr(BaseFormat, "attribute_map"):
        attribute_map.update(BaseFormat.attribute_map)

    def __init__(self, type=None, date_format=None, display_pricing_source=None, *args, **kwargs):  # noqa: E501
        """HistoryFormat - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._date_format = None
        self._display_pricing_source = None
        self.discriminator = None
        self.type = type
        if date_format is not None:
            self.date_format = date_format
        if display_pricing_source is not None:
            self.display_pricing_source = display_pricing_source
        BaseFormat.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this HistoryFormat.  # noqa: E501


        :return: The type of this HistoryFormat.  # noqa: E501
        :rtype: object
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this HistoryFormat.


        :param type: The type of this HistoryFormat.  # noqa: E501
        :type: object
        """
        if type is None:
    ...
    def date_format(self):
        """Gets the date_format of this HistoryFormat.  # noqa: E501


        :return: The date_format of this HistoryFormat.  # noqa: E501
        :rtype: DateFormat
        """
    ...
    def date_format(self, date_format):
        """Sets the date_format of this HistoryFormat.


        :param date_format: The date_format of this HistoryFormat.  # noqa: E501
        :type: DateFormat
        """
    ...
    @property
    def display_pricing_source(self):
        """Gets the display_pricing_source of this HistoryFormat.  # noqa: E501

        This option is available in for Corp, Pfd, Govt, Muni and Mtge securities. If this option is used, the PRICING_SOURCE will be returned in the output file.  # noqa: E501

        :return: The display_pricing_source of this HistoryFormat.  # noqa: E501
        :rtype: bool
        """
        return self._display_pricing_source

    @display_pricing_source.setter
    def display_pricing_source(self, display_pricing_source):
        """Sets the display_pricing_source of this HistoryFormat.

        This option is available in for Corp, Pfd, Govt, Muni and Mtge securities. If this option is used, the PRICING_SOURCE will be returned in the output file.  # noqa: E501

        :param display_pricing_source: The display_pricing_source of this HistoryFormat.  # noqa: E501
        :type: bool
        """

        self._display_pricing_source = display_pricing_source
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HistoryFormat, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HistoryFormat):
            return False
