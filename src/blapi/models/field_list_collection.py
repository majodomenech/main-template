...
import six
from blapi.models.components import Components  # noqa: F401,E501

class FieldListCollection(Components):
    ...
    if hasattr(Components, "swagger_types"):
        swagger_types.update(Components.swagger_types)
    ...
    if hasattr(Components, "attribute_map"):
        attribute_map.update(Components.attribute_map)

    def __init__(self, context=None, id=None, type=None, contains=None, identifier=None, *args, **kwargs):  # noqa: E501
        """FieldListCollection - a model defined in Swagger"""  # noqa: E501
        self._context = None
        self._id = None
        self._type = None
        self._contains = None
        ...
        Components.__init__(self, *args, **kwargs)

    @property
    def context(self):
        """Gets the context of this FieldListCollection.  # noqa: E501


        :return: The context of this FieldListCollection.  # noqa: E501
        :rtype: Context
        """
    ...
    def context(self, context):
        """Sets the context of this FieldListCollection.


        :param context: The context of this FieldListCollection.  # noqa: E501
        :type: Context
        """
        if context is None:
    ...
    @property
    def id(self):
        """Gets the id of this FieldListCollection.  # noqa: E501


        :return: The id of this FieldListCollection.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FieldListCollection.


        :param id: The id of this FieldListCollection.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    @property
    def type(self):
        """Gets the type of this FieldListCollection.  # noqa: E501


        :return: The type of this FieldListCollection.  # noqa: E501
        :rtype: object
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this FieldListCollection.


        :param type: The type of this FieldListCollection.  # noqa: E501
        :type: object
        """
        if type is None:
    ...
    @property
    def contains(self):
        """Gets the contains of this FieldListCollection.  # noqa: E501

        The paginated elements of this collection.  # noqa: E501

        :return: The contains of this FieldListCollection.  # noqa: E501
        :rtype: list[FieldListSummary]
        """
        return self._contains

    @contains.setter
    def contains(self, contains):
        """Sets the contains of this FieldListCollection.

        The paginated elements of this collection.  # noqa: E501

        :param contains: The contains of this FieldListCollection.  # noqa: E501
        :type: list[FieldListSummary]
        """
        if contains is None:
    ...
    @property
    def identifier(self):
        """Gets the identifier of this FieldListCollection.  # noqa: E501


        :return: The identifier of this FieldListCollection.  # noqa: E501
        :rtype: Identifier
        """
    ...
    def identifier(self, identifier):
        """Sets the identifier of this FieldListCollection.


        :param identifier: The identifier of this FieldListCollection.  # noqa: E501
        :type: Identifier
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FieldListCollection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FieldListCollection):
            return False
