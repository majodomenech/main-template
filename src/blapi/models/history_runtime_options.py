...
class HistoryRuntimeOptions(object):
    ...
    swagger_types = {
        ...
        'date_range': 'OneOfHistoryRuntimeOptionsDateRange',
        'history_price_currency': 'str',
        'period': 'str'
    }
    ...
    attribute_map = {
        ...
        'history_price_currency': 'historyPriceCurrency',
        'period': 'period'
    }

    def __init__(self, type=None, date_range=None, history_price_currency=None, period=None):  # noqa: E501
        """HistoryRuntimeOptions - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._date_range = None
        self._history_price_currency = None
        self._period = None
        self.discriminator = None
        self.type = type
        if date_range is not None:
            self.date_range = date_range
        if history_price_currency is not None:
            self.history_price_currency = history_price_currency
        if period is not None:
            self.period = period

    @property
    def type(self):
        """Gets the type of this HistoryRuntimeOptions.  # noqa: E501


        :return: The type of this HistoryRuntimeOptions.  # noqa: E501
        :rtype: AllOfHistoryRuntimeOptionsType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this HistoryRuntimeOptions.


        :param type: The type of this HistoryRuntimeOptions.  # noqa: E501
        :type: AllOfHistoryRuntimeOptionsType
        """
        if type is None:
    ...
    @property
    def date_range(self):
        """Gets the date_range of this HistoryRuntimeOptions.  # noqa: E501

        This parameter is used to specify the date range for output data.  # noqa: E501

        :return: The date_range of this HistoryRuntimeOptions.  # noqa: E501
        :rtype: OneOfHistoryRuntimeOptionsDateRange
        """
        return self._date_range

    @date_range.setter
    def date_range(self, date_range):
        """Sets the date_range of this HistoryRuntimeOptions.

        This parameter is used to specify the date range for output data.  # noqa: E501

        :param date_range: The date_range of this HistoryRuntimeOptions.  # noqa: E501
        :type: OneOfHistoryRuntimeOptionsDateRange
        """

        self._date_range = date_range

    @property
    def history_price_currency(self):
        """Gets the history_price_currency of this HistoryRuntimeOptions.  # noqa: E501

        This option allows for the specification of a desired currency for history requests.  # noqa: E501

        :return: The history_price_currency of this HistoryRuntimeOptions.  # noqa: E501
        :rtype: str
        """
        return self._history_price_currency

    @history_price_currency.setter
    def history_price_currency(self, history_price_currency):
        """Sets the history_price_currency of this HistoryRuntimeOptions.

        This option allows for the specification of a desired currency for history requests.  # noqa: E501

        :param history_price_currency: The history_price_currency of this HistoryRuntimeOptions.  # noqa: E501
        :type: str
        """

        self._history_price_currency = history_price_currency

    @property
    def period(self):
        """Gets the period of this HistoryRuntimeOptions.  # noqa: E501

        Set the time step (periodicity) of the request. For every period within the specified dateRange the return value is the final data point at the end of the period. Defaults to \"daily\".  # noqa: E501

        :return: The period of this HistoryRuntimeOptions.  # noqa: E501
        :rtype: str
        """
        return self._period
    ...
    def period(self, period):
        """Sets the period of this HistoryRuntimeOptions.

        Set the time step (periodicity) of the request. For every period within the specified dateRange the return value is the final data point at the end of the period. Defaults to \"daily\".  # noqa: E501

        :param period: The period of this HistoryRuntimeOptions.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HistoryRuntimeOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HistoryRuntimeOptions):
            return False
