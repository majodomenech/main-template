...
class ArchivesItem(object):
    ...
    swagger_types = {
        ...
        'start_snapshot_date': 'ArchiveStartDate',
        'end_snapshot_date': 'ArchiveEndDate',
        'issued': 'Issued',
    ...
    attribute_map = {
        'id': '@id',
        'type': '@type',
        'start_snapshot_date': 'startSnapshotDate',
    ...
    def __init__(self, id=None, type=None, start_snapshot_date=None, end_snapshot_date=None, issued=None, status=None, accessible=None, content_type=None):  # noqa: E501
        """ArchivesItem - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._type = None
        self._start_snapshot_date = None
        self._end_snapshot_date = None
        self._issued = None
        self._status = None
        ...
        self.id = id
        self.type = type
        self.start_snapshot_date = start_snapshot_date
        self.end_snapshot_date = end_snapshot_date
        self.issued = issued
        self.status = status
    ...
    @property
    def id(self):
        """Gets the id of this ArchivesItem.  # noqa: E501


        :return: The id of this ArchivesItem.  # noqa: E501
        :rtype: Id
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ArchivesItem.


        :param id: The id of this ArchivesItem.  # noqa: E501
        :type: Id
        """
        if id is None:
    ...
    @property
    def type(self):
        """Gets the type of this ArchivesItem.  # noqa: E501


        :return: The type of this ArchivesItem.  # noqa: E501
        :rtype: AnyOfArchivesItemType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this ArchivesItem.


        :param type: The type of this ArchivesItem.  # noqa: E501
        :type: AnyOfArchivesItemType
        """
        if type is None:
    ...
    @property
    def start_snapshot_date(self):
        """Gets the start_snapshot_date of this ArchivesItem.  # noqa: E501


        :return: The start_snapshot_date of this ArchivesItem.  # noqa: E501
        :rtype: ArchiveStartDate
        """
        return self._start_snapshot_date

    @start_snapshot_date.setter
    def start_snapshot_date(self, start_snapshot_date):
        """Sets the start_snapshot_date of this ArchivesItem.


        :param start_snapshot_date: The start_snapshot_date of this ArchivesItem.  # noqa: E501
        :type: ArchiveStartDate
        """
        if start_snapshot_date is None:
            raise ValueError("Invalid value for `start_snapshot_date`, must not be `None`")  # noqa: E501

        self._start_snapshot_date = start_snapshot_date

    @property
    def end_snapshot_date(self):
        """Gets the end_snapshot_date of this ArchivesItem.  # noqa: E501


        :return: The end_snapshot_date of this ArchivesItem.  # noqa: E501
        :rtype: ArchiveEndDate
        """
        return self._end_snapshot_date

    @end_snapshot_date.setter
    def end_snapshot_date(self, end_snapshot_date):
        """Sets the end_snapshot_date of this ArchivesItem.


        :param end_snapshot_date: The end_snapshot_date of this ArchivesItem.  # noqa: E501
        :type: ArchiveEndDate
        """
        if end_snapshot_date is None:
            raise ValueError("Invalid value for `end_snapshot_date`, must not be `None`")  # noqa: E501

        self._end_snapshot_date = end_snapshot_date

    @property
    def issued(self):
        """Gets the issued of this ArchivesItem.  # noqa: E501


        :return: The issued of this ArchivesItem.  # noqa: E501
        :rtype: Issued
        """
        return self._issued
    ...
    def issued(self, issued):
        """Sets the issued of this ArchivesItem.


        :param issued: The issued of this ArchivesItem.  # noqa: E501
        :type: Issued
        """
        if issued is None:
    ...
    @property
    def status(self):
        """Gets the status of this ArchivesItem.  # noqa: E501


        :return: The status of this ArchivesItem.  # noqa: E501
        :rtype: ArchiveStatus
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ArchivesItem.


        :param status: The status of this ArchivesItem.  # noqa: E501
        :type: ArchiveStatus
        """
        if status is None:
    ...
    @property
    def accessible(self):
        """Gets the accessible of this ArchivesItem.  # noqa: E501


        :return: The accessible of this ArchivesItem.  # noqa: E501
        :rtype: bool
        """
    ...
    def accessible(self, accessible):
        """Sets the accessible of this ArchivesItem.


        :param accessible: The accessible of this ArchivesItem.  # noqa: E501
        :type: bool
        """
        if accessible is None:
            raise ValueError("Invalid value for `accessible`, must not be `None`")  # noqa: E501

        self._accessible = accessible

    @property
    def content_type(self):
        """Gets the content_type of this ArchivesItem.  # noqa: E501


        :return: The content_type of this ArchivesItem.  # noqa: E501
        :rtype: ArchiveContentType
        """
        return self._content_type

    @content_type.setter
    def content_type(self, content_type):
        """Sets the content_type of this ArchivesItem.


        :param content_type: The content_type of this ArchivesItem.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ArchivesItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArchivesItem):
            return False
