...
class PaginatedView(object):
    ...
    def __init__(self, type=None, id=None, first=None, last=None, next=None, previous=None):  # noqa: E501
        """PaginatedView - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._id = None
        self._first = None
        self._last = None
    ...
    @property
    def type(self):
        """Gets the type of this PaginatedView.  # noqa: E501

        Bloomberg vocabulary, see 'PartialCollectionView' in [https://api.bloomberg.com/eap/ontology#](https://data.bloomberg.com/catalogs/bbg/datasets/beapOntology/snapshots/20200406/distributions/beapOntology.ttl)  # noqa: E501

        :return: The type of this PaginatedView.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PaginatedView.

        Bloomberg vocabulary, see 'PartialCollectionView' in [https://api.bloomberg.com/eap/ontology#](https://data.bloomberg.com/catalogs/bbg/datasets/beapOntology/snapshots/20200406/distributions/beapOntology.ttl)  # noqa: E501

        :param type: The type of this PaginatedView.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["PartialCollectionView"]  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this PaginatedView.  # noqa: E501


        :return: The id of this PaginatedView.  # noqa: E501
        :rtype: Id
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this PaginatedView.


        :param id: The id of this PaginatedView.  # noqa: E501
        :type: Id
        """
        if id is None:
    ...
    @property
    def first(self):
        """Gets the first of this PaginatedView.  # noqa: E501


        :return: The first of this PaginatedView.  # noqa: E501
        :rtype: First
        """
        return self._first
    ...
    def first(self, first):
        """Sets the first of this PaginatedView.


        :param first: The first of this PaginatedView.  # noqa: E501
        :type: First
        """
        if first is None:
    ...
    @property
    def last(self):
        """Gets the last of this PaginatedView.  # noqa: E501


        :return: The last of this PaginatedView.  # noqa: E501
        :rtype: Last
        """
        return self._last
    ...
    @last.setter
    def last(self, last):
        """Sets the last of this PaginatedView.


        :param last: The last of this PaginatedView.  # noqa: E501
        :type: Last
        """
        if last is None:
    ...
    @property
    def next(self):
        """Gets the next of this PaginatedView.  # noqa: E501


        :return: The next of this PaginatedView.  # noqa: E501
        :rtype: Next
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this PaginatedView.


        :param next: The next of this PaginatedView.  # noqa: E501
        :type: Next
        """
    ...
    @property
    def previous(self):
        """Gets the previous of this PaginatedView.  # noqa: E501


        :return: The previous of this PaginatedView.  # noqa: E501
        :rtype: Previous
        """
    ...
    def previous(self, previous):
        """Sets the previous of this PaginatedView.


        :param previous: The previous of this PaginatedView.  # noqa: E501
        :type: Previous
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaginatedView, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaginatedView):
            return False
