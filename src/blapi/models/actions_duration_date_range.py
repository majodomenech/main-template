...
class ActionsDurationDateRange(object):
    ...
    def __init__(self, type=None, days=0):  # noqa: E501
        """ActionsDurationDateRange - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._days = None
    ...
    @property
    def type(self):
        """Gets the type of this ActionsDurationDateRange.  # noqa: E501


        :return: The type of this ActionsDurationDateRange.  # noqa: E501
        :rtype: AllOfActionsDurationDateRangeType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this ActionsDurationDateRange.


        :param type: The type of this ActionsDurationDateRange.  # noqa: E501
        :type: AllOfActionsDurationDateRangeType
        """
        if type is None:
    ...
    @property
    def days(self):
        """Gets the days of this ActionsDurationDateRange.  # noqa: E501

        The number of calendar days between the start of the request and the current day.  # noqa: E501

        :return: The days of this ActionsDurationDateRange.  # noqa: E501
        :rtype: int
        """
        return self._days
    ...
    @days.setter
    def days(self, days):
        """Sets the days of this ActionsDurationDateRange.

        The number of calendar days between the start of the request and the current day.  # noqa: E501

        :param days: The days of this ActionsDurationDateRange.  # noqa: E501
        :type: int
        """
        if days is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ActionsDurationDateRange, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActionsDurationDateRange):
            return False
