...
class ErrorSourceBody(object):
    ...
    def __init__(self, location=None, pointer=None):  # noqa: E501
        """ErrorSourceBody - a model defined in Swagger"""  # noqa: E501
        self._location = None
        self._pointer = None
    ...
    @property
    def location(self):
        """Gets the location of this ErrorSourceBody.  # noqa: E501


        :return: The location of this ErrorSourceBody.  # noqa: E501
        :rtype: ErrorSourceLocation
        """
        return self._location

    @location.setter
    def location(self, location):
        """Sets the location of this ErrorSourceBody.


        :param location: The location of this ErrorSourceBody.  # noqa: E501
    ...
    @property
    def pointer(self):
        """Gets the pointer of this ErrorSourceBody.  # noqa: E501

        A [RFC6901 JSON pointer](https://tools.ietf.org/html/rfc6901) to the invalid data within the request body.  # noqa: E501

        :return: The pointer of this ErrorSourceBody.  # noqa: E501
        :rtype: str
        """
    ...
    def pointer(self, pointer):
        """Sets the pointer of this ErrorSourceBody.

        A [RFC6901 JSON pointer](https://tools.ietf.org/html/rfc6901) to the invalid data within the request body.  # noqa: E501

        :param pointer: The pointer of this ErrorSourceBody.  # noqa: E501
        :type: str
        """
        if pointer is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ErrorSourceBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ErrorSourceBody):
            return False
