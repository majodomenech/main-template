...
class DurationDateRange(object):
    ...
    def __init__(self, type=None, days=None, future_days=None):  # noqa: E501
        """DurationDateRange - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._days = None
        self._future_days = None
    ...
    @property
    def type(self):
        """Gets the type of this DurationDateRange.  # noqa: E501


        :return: The type of this DurationDateRange.  # noqa: E501
        :rtype: AllOfDurationDateRangeType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this DurationDateRange.


        :param type: The type of this DurationDateRange.  # noqa: E501
        :type: AllOfDurationDateRangeType
        """
        if type is None:
    ...
    @property
    def days(self):
        """Gets the days of this DurationDateRange.  # noqa: E501

        The number of calendar days between the start of the time series and the current day.  # noqa: E501

        :return: The days of this DurationDateRange.  # noqa: E501
        :rtype: int
        """
        return self._days
    ...
    @days.setter
    def days(self, days):
        """Sets the days of this DurationDateRange.

        The number of calendar days between the start of the time series and the current day.  # noqa: E501

        :param days: The days of this DurationDateRange.  # noqa: E501
        :type: int
        """
        if days is None:
    ...
    def future_days(self):
        """Gets the future_days of this DurationDateRange.  # noqa: E501

        The number of calendar days from current day to the end of the time series, where the data is estimated or projected beyond the current day.  # noqa: E501

        :return: The future_days of this DurationDateRange.  # noqa: E501
        :rtype: int
        """
        return self._future_days

    @future_days.setter
    def future_days(self, future_days):
        """Sets the future_days of this DurationDateRange.

        The number of calendar days from current day to the end of the time series, where the data is estimated or projected beyond the current day.  # noqa: E501

        :param future_days: The future_days of this DurationDateRange.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DurationDateRange, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DurationDateRange):
            return False
