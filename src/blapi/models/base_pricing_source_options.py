...
class BasePricingSourceOptions(object):
    ...
    def __init__(self, type=None, prefer=None, exclusive=None):  # noqa: E501
        """BasePricingSourceOptions - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._prefer = None
    ...
    @property
    def type(self):
        """Gets the type of this BasePricingSourceOptions.  # noqa: E501


        :return: The type of this BasePricingSourceOptions.  # noqa: E501
        :rtype: Type
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this BasePricingSourceOptions.


        :param type: The type of this BasePricingSourceOptions.  # noqa: E501
        :type: Type
        """
        if type is None:
    ...
    @property
    def prefer(self):
        """Gets the prefer of this BasePricingSourceOptions.  # noqa: E501


        :return: The prefer of this BasePricingSourceOptions.  # noqa: E501
        :rtype: PricingSourceDetail
        """
        return self._prefer

    @prefer.setter
    def prefer(self, prefer):
        """Sets the prefer of this BasePricingSourceOptions.


        :param prefer: The prefer of this BasePricingSourceOptions.  # noqa: E501
    ...
    @property
    def exclusive(self):
        """Gets the exclusive of this BasePricingSourceOptions.  # noqa: E501
        ...
        :return: The exclusive of this BasePricingSourceOptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def exclusive(self, exclusive):
        """Sets the exclusive of this BasePricingSourceOptions.

        This option applies to Bonds, and allows an exclusive pricing source to be designated when setting the pricing source for the request. If the exclusive source is not available, all fields in the Pricing and Derived Data field categories will return `N.A.` for that security. Return code `989` will be returned if the client is not privileged to see the pricing source requested.  # noqa: E501

        :param exclusive: The exclusive of this BasePricingSourceOptions.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BasePricingSourceOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BasePricingSourceOptions):
            return False
