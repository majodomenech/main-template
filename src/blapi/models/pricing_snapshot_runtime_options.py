...
class PricingSnapshotRuntimeOptions(object):
    ...
    attribute_map = {
        'type': '@type',
        'max_embargo': 'maxEmbargo'
    }

    def __init__(self, type=None, max_embargo=None):  # noqa: E501
        """PricingSnapshotRuntimeOptions - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._max_embargo = None
        self.discriminator = None
        self.type = type
        if max_embargo is not None:
            self.max_embargo = max_embargo

    @property
    def type(self):
        """Gets the type of this PricingSnapshotRuntimeOptions.  # noqa: E501


        :return: The type of this PricingSnapshotRuntimeOptions.  # noqa: E501
        :rtype: AllOfPricingSnapshotRuntimeOptionsType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this PricingSnapshotRuntimeOptions.


        :param type: The type of this PricingSnapshotRuntimeOptions.  # noqa: E501
        :type: AllOfPricingSnapshotRuntimeOptionsType
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PricingSnapshotRuntimeOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PricingSnapshotRuntimeOptions):
            return False
