...
class FieldListInputItemMnemonic(object):
    ...
    def __init__(self, mnemonic=None):  # noqa: E501
        """FieldListInputItemMnemonic - a model defined in Swagger"""  # noqa: E501
        self._mnemonic = None
    ...
    @property
    def mnemonic(self):
        """Gets the mnemonic of this FieldListInputItemMnemonic.  # noqa: E501


        :return: The mnemonic of this FieldListInputItemMnemonic.  # noqa: E501
        :rtype: Mnemonic
        """
    ...
    def mnemonic(self, mnemonic):
        """Sets the mnemonic of this FieldListInputItemMnemonic.


        :param mnemonic: The mnemonic of this FieldListInputItemMnemonic.  # noqa: E501
        :type: Mnemonic
        """
        if mnemonic is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FieldListInputItemMnemonic, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FieldListInputItemMnemonic):
            return False
