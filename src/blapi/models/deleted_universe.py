...
import six
from blapi.models.universe import Universe  # noqa: F401,E501

class DeletedUniverse(Universe):
    ...
    if hasattr(Universe, "swagger_types"):
        swagger_types.update(Universe.swagger_types)

    attribute_map = {
        'deleted_on': 'deletedOn'
    }
    if hasattr(Universe, "attribute_map"):
        attribute_map.update(Universe.attribute_map)

    def __init__(self, deleted_on=None, *args, **kwargs):  # noqa: E501
        """DeletedUniverse - a model defined in Swagger"""  # noqa: E501
        self._deleted_on = None
        self.discriminator = None
        self.deleted_on = deleted_on
        Universe.__init__(self, *args, **kwargs)

    @property
    def deleted_on(self):
        """Gets the deleted_on of this DeletedUniverse.  # noqa: E501


        :return: The deleted_on of this DeletedUniverse.  # noqa: E501
        :rtype: DeletedOn
        """
    ...
    def deleted_on(self, deleted_on):
        """Sets the deleted_on of this DeletedUniverse.


        :param deleted_on: The deleted_on of this DeletedUniverse.  # noqa: E501
        :type: DeletedOn
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedUniverse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedUniverse):
            return False
