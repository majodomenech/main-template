...
import six
from blapi.models.base_dataset import BaseDataset  # noqa: F401,E501

class PricingSnapshotDataset(BaseDataset):
    ...
    if hasattr(BaseDataset, "swagger_types"):
        swagger_types.update(BaseDataset.swagger_types)

    attribute_map = {
        'type': '@type',
        'request': 'request'
    }
    if hasattr(BaseDataset, "attribute_map"):
        attribute_map.update(BaseDataset.attribute_map)

    def __init__(self, type=None, request=None, *args, **kwargs):  # noqa: E501
        """PricingSnapshotDataset - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._request = None
    ...
    @property
    def type(self):
        """Gets the type of this PricingSnapshotDataset.  # noqa: E501


        :return: The type of this PricingSnapshotDataset.  # noqa: E501
        :rtype: object
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PricingSnapshotDataset.


        :param type: The type of this PricingSnapshotDataset.  # noqa: E501
        :type: object
        """
        if type is None:
    ...
    @property
    def request(self):
        """Gets the request of this PricingSnapshotDataset.  # noqa: E501


        :return: The request of this PricingSnapshotDataset.  # noqa: E501
    ...
    def request(self, request):
        """Sets the request of this PricingSnapshotDataset.


        :param request: The request of this PricingSnapshotDataset.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PricingSnapshotDataset, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PricingSnapshotDataset):
            return False
