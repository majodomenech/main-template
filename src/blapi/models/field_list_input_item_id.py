...
class FieldListInputItemId(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """FieldListInputItemId - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this FieldListInputItemId.  # noqa: E501


        :return: The id of this FieldListInputItemId.  # noqa: E501
        :rtype: Id
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FieldListInputItemId.


        :param id: The id of this FieldListInputItemId.  # noqa: E501
        :type: Id
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FieldListInputItemId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FieldListInputItemId):
            return False
