...
import six
from blapi.models.base_format import BaseFormat  # noqa: F401,E501

class BvalSnapshotFormat(BaseFormat):
    ...
    if hasattr(BaseFormat, "swagger_types"):
        swagger_types.update(BaseFormat.swagger_types)
    ...
    if hasattr(BaseFormat, "attribute_map"):
        attribute_map.update(BaseFormat.attribute_map)

    def __init__(self, type=None, column_header=None, date_format=None, delimiter=None, output_format=None, *args, **kwargs):  # noqa: E501
        """BvalSnapshotFormat - a model defined in Swagger"""  # noqa: E501
        self._type = None
        ...
        BaseFormat.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this BvalSnapshotFormat.  # noqa: E501


        :return: The type of this BvalSnapshotFormat.  # noqa: E501
        :rtype: object
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this BvalSnapshotFormat.


        :param type: The type of this BvalSnapshotFormat.  # noqa: E501
        :type: object
        """
        if type is None:
    ...
    def column_header(self):
        """Gets the column_header of this BvalSnapshotFormat.  # noqa: E501

        Determines if the response will return the title of each column of data.  # noqa: E501

        :return: The column_header of this BvalSnapshotFormat.  # noqa: E501
        :rtype: bool
        """
    ...
    def column_header(self, column_header):
        """Sets the column_header of this BvalSnapshotFormat.

        Determines if the response will return the title of each column of data.  # noqa: E501

        :param column_header: The column_header of this BvalSnapshotFormat.  # noqa: E501
        :type: bool
        """
    ...
    def date_format(self):
        """Gets the date_format of this BvalSnapshotFormat.  # noqa: E501


        :return: The date_format of this BvalSnapshotFormat.  # noqa: E501
        :rtype: DateFormat
        """
    ...
    def date_format(self, date_format):
        """Sets the date_format of this BvalSnapshotFormat.


        :param date_format: The date_format of this BvalSnapshotFormat.  # noqa: E501
        :type: DateFormat
        """
    ...
    @property
    def delimiter(self):
        """Gets the delimiter of this BvalSnapshotFormat.  # noqa: E501

        This option allows the specification of the delimiter that is used in the response. If a delimiter is specified and it is not a `|` (Unix pipe character), all text fields will be surrounded with double quotes.  # noqa: E501

        :return: The delimiter of this BvalSnapshotFormat.  # noqa: E501
        :rtype: str
        """
    ...
    def delimiter(self, delimiter):
        """Sets the delimiter of this BvalSnapshotFormat.

        This option allows the specification of the delimiter that is used in the response. If a delimiter is specified and it is not a `|` (Unix pipe character), all text fields will be surrounded with double quotes.  # noqa: E501

        :param delimiter: The delimiter of this BvalSnapshotFormat.  # noqa: E501
        :type: str
        """
        allowed_values = ["|", ",", ";"]  # noqa: E501
        if delimiter not in allowed_values:
            raise ValueError(
                "Invalid value for `delimiter` ({0}), must be one of {1}"  # noqa: E501
                .format(delimiter, allowed_values)
            )
    ...
    def output_format(self):
        """Gets the output_format of this BvalSnapshotFormat.  # noqa: E501

        This option controls the format of responses, such as the implementation of a delimiter.  # noqa: E501

        :return: The output_format of this BvalSnapshotFormat.  # noqa: E501
        :rtype: str
        """
    ...
    def output_format(self, output_format):
        """Sets the output_format of this BvalSnapshotFormat.

        This option controls the format of responses, such as the implementation of a delimiter.  # noqa: E501

        :param output_format: The output_format of this BvalSnapshotFormat.  # noqa: E501
        :type: str
        """
        allowed_values = ["bulkListOutputFormat", "fixedOutputFormat", "variableOutputFormat"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BvalSnapshotFormat, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BvalSnapshotFormat):
            return False
