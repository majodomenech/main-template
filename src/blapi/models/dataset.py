...
class Dataset(BaseDataset):
    ...
    @property
    def request(self):
        """Gets the request of this Dataset.  # noqa: E501


        :return: The request of this Dataset.  # noqa: E501
    ...
    def request(self, request):
        """Sets the request of this Dataset.


        :param request: The request of this Dataset.  # noqa: E501
