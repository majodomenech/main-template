...
class TickHistoryRuntimeOptions(object):
    ...
    swagger_types = {
        ...
        'date_time_range': 'IntervalDateTimeRange',
        'tick_type': 'str'
    }
    ...
    def __init__(self, type=None, date_time_range=None, tick_type='trades'):  # noqa: E501
        """TickHistoryRuntimeOptions - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this TickHistoryRuntimeOptions.  # noqa: E501


        :return: The type of this TickHistoryRuntimeOptions.  # noqa: E501
        :rtype: AllOfTickHistoryRuntimeOptionsType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this TickHistoryRuntimeOptions.


        :param type: The type of this TickHistoryRuntimeOptions.  # noqa: E501
        :type: AllOfTickHistoryRuntimeOptionsType
        """
        if type is None:
    ...
    def date_time_range(self):
        """Gets the date_time_range of this TickHistoryRuntimeOptions.  # noqa: E501


        :return: The date_time_range of this TickHistoryRuntimeOptions.  # noqa: E501
        :rtype: IntervalDateTimeRange
        """
        return self._date_time_range

    @date_time_range.setter
    def date_time_range(self, date_time_range):
        """Sets the date_time_range of this TickHistoryRuntimeOptions.


        :param date_time_range: The date_time_range of this TickHistoryRuntimeOptions.  # noqa: E501
        :type: IntervalDateTimeRange
        """
        if date_time_range is None:
            raise ValueError("Invalid value for `date_time_range`, must not be `None`")  # noqa: E501

        self._date_time_range = date_time_range

    @property
    def tick_type(self):
        """Gets the tick_type of this TickHistoryRuntimeOptions.  # noqa: E501

        Provides a string value that indicates the type of a Tick such as trades, quotes or both.  # noqa: E501

        :return: The tick_type of this TickHistoryRuntimeOptions.  # noqa: E501
        :rtype: str
        """
    ...
    def tick_type(self, tick_type):
        """Sets the tick_type of this TickHistoryRuntimeOptions.

        Provides a string value that indicates the type of a Tick such as trades, quotes or both.  # noqa: E501

        :param tick_type: The tick_type of this TickHistoryRuntimeOptions.  # noqa: E501
        :type: str
        """
        allowed_values = ["trades", "quotes", "quotesAndTrades"]  # noqa: E501
        if tick_type not in allowed_values:
            raise ValueError(
                "Invalid value for `tick_type` ({0}), must be one of {1}"  # noqa: E501
                .format(tick_type, allowed_values)
            )
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TickHistoryRuntimeOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TickHistoryRuntimeOptions):
            return False
