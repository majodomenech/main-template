...
class TriggersApi(object):
    ...
    def delete_trigger(self, catalog, trigger_name, jwt, api_version, **kwargs):  # noqa: E501
        """Delete a trigger resource  # noqa: E501

        Triggers that are referenced by active recurring requests CAN NOT be deleted and will return a status code of 400  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_trigger(catalog, trigger_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_trigger_with_http_info(catalog, trigger_name, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_trigger_with_http_info(catalog, trigger_name, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def delete_trigger_with_http_info(self, catalog, trigger_name, jwt, api_version, **kwargs):  # noqa: E501
        """Delete a trigger resource  # noqa: E501

        Triggers that are referenced by active recurring requests CAN NOT be deleted and will return a status code of 400  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_trigger_with_http_info(catalog, trigger_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('catalog' not in params or
            ...
            raise ValueError("Missing the required parameter `catalog` when calling `delete_trigger`")  # noqa: E501
        # verify the required parameter 'trigger_name' is set
        if ('trigger_name' not in params or
                params['trigger_name'] is None):
            raise ValueError("Missing the required parameter `trigger_name` when calling `delete_trigger`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `delete_trigger`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `delete_trigger`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/triggers/{triggerName}/', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_deleted_trigger(self, catalog, trigger_uuid, jwt, api_version, **kwargs):  # noqa: E501
        """Deleted trigger resource  # noqa: E501

        A trigger that has been deleted.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_deleted_trigger(catalog, trigger_uuid, jwt, api_version, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str catalog: Catalog identifier. Must be either `bbg` or the customer's DL account number (e.g. `1234`). (required)
        :param str trigger_uuid: Trigger unique identifier. (required)
        :param str jwt: JWT(https://tools.ietf.org/html/rfc7519) Authentication token (required)
        :param str api_version: Version of the API to access. The only valid value is 2. (required)
        :return: PolymorphicDeletedTrigger
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_deleted_trigger_with_http_info(catalog, trigger_uuid, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_deleted_trigger_with_http_info(catalog, trigger_uuid, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_deleted_trigger_with_http_info(self, catalog, trigger_uuid, jwt, api_version, **kwargs):  # noqa: E501
        """Deleted trigger resource  # noqa: E501

        A trigger that has been deleted.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_deleted_trigger_with_http_info(catalog, trigger_uuid, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['catalog', 'trigger_uuid', 'jwt', 'api_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_deleted_trigger" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'catalog' is set
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_deleted_trigger`")  # noqa: E501
        # verify the required parameter 'trigger_uuid' is set
        if ('trigger_uuid' not in params or
                params['trigger_uuid'] is None):
            raise ValueError("Missing the required parameter `trigger_uuid` when calling `get_deleted_trigger`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_deleted_trigger`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_deleted_trigger`")  # noqa: E501
        ...
        if 'trigger_uuid' in params:
            path_params['triggerUUID'] = params['trigger_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/deleted/triggers/{triggerUUID}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PolymorphicDeletedTrigger',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_trigger(self, catalog, trigger_name, jwt, api_version, **kwargs):  # noqa: E501
        """A trigger resource  # noqa: E501

        A trigger resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_trigger(catalog, trigger_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        :param str jwt: JWT(https://tools.ietf.org/html/rfc7519) Authentication token (required)
        :param str api_version: Version of the API to access. The only valid value is 2. (required)
        :return: PolymorphicTrigger
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_trigger_with_http_info(catalog, trigger_name, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_trigger_with_http_info(catalog, trigger_name, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_trigger_with_http_info(self, catalog, trigger_name, jwt, api_version, **kwargs):  # noqa: E501
        """A trigger resource  # noqa: E501

        A trigger resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_trigger_with_http_info(catalog, trigger_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_trigger`")  # noqa: E501
        # verify the required parameter 'trigger_name' is set
        if ('trigger_name' not in params or
                params['trigger_name'] is None):
            raise ValueError("Missing the required parameter `trigger_name` when calling `get_trigger`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_trigger`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_trigger`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/triggers/{triggerName}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PolymorphicTrigger',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_triggers(self, catalog, jwt, api_version, **kwargs):  # noqa: E501
        """A collection of triggers  # noqa: E501

        A collection of triggers within a specific catalog.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_triggers(catalog, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_triggers_with_http_info(catalog, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_triggers_with_http_info(catalog, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_triggers_with_http_info(self, catalog, jwt, api_version, **kwargs):  # noqa: E501
        """A collection of triggers  # noqa: E501

        A collection of triggers within a specific catalog.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_triggers_with_http_info(catalog, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_triggers`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_triggers`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_triggers`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TriggerCollection',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def patch_trigger(self, body, jwt, api_version, content_type, catalog, trigger_name, **kwargs):  # noqa: E501
        """Update a trigger resource  # noqa: E501

        Triggers that are referenced by active recurring requests CAN NOT be updated and will return a status code of 400.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_trigger(body, jwt, api_version, content_type, catalog, trigger_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TriggerPatchPayload body: (required)
        :param str jwt: JWT(https://tools.ietf.org/html/rfc7519) Authentication token (required)
        :param str api_version: Version of the API to access. The only valid value is 2. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_trigger_with_http_info(body, jwt, api_version, content_type, catalog, trigger_name, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_trigger_with_http_info(body, jwt, api_version, content_type, catalog, trigger_name, **kwargs)  # noqa: E501
            return data

    def patch_trigger_with_http_info(self, body, jwt, api_version, content_type, catalog, trigger_name, **kwargs):  # noqa: E501
        """Update a trigger resource  # noqa: E501

        Triggers that are referenced by active recurring requests CAN NOT be updated and will return a status code of 400.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_trigger_with_http_info(body, jwt, api_version, content_type, catalog, trigger_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'jwt', 'api_version', 'content_type', 'catalog', 'trigger_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `patch_trigger`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `patch_trigger`")  # noqa: E501
        # verify the required parameter 'content_type' is set
        if ('content_type' not in params or
                params['content_type'] is None):
            raise ValueError("Missing the required parameter `content_type` when calling `patch_trigger`")  # noqa: E501
        # verify the required parameter 'catalog' is set
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `patch_trigger`")  # noqa: E501
        # verify the required parameter 'trigger_name' is set
        if ('trigger_name' not in params or
                params['trigger_name'] is None):
            raise ValueError("Missing the required parameter `trigger_name` when calling `patch_trigger`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/triggers/{triggerName}/', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_trigger(self, body, jwt, api_version, content_type, catalog, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_trigger_with_http_info(body, jwt, api_version, content_type, catalog, **kwargs)  # noqa: E501
        else:
            (data) = self.post_trigger_with_http_info(body, jwt, api_version, content_type, catalog, **kwargs)  # noqa: E501
            return data

    def post_trigger_with_http_info(self, body, jwt, api_version, content_type, catalog, **kwargs):  # noqa: E501
        """Create a new trigger resource  # noqa: E501

        Create a new trigger resource. Requires an identifier (the name, used to construct the URI, must begin with a letter and consist only of alphanumeric characters), title (short description) and the contents  | Trigger @type | Action | Time Zone | Time Behavior | Frequency | Scheduling Behavior | | --- | --- | --- | --- | --- | --- | | ScheduledTrigger | Execute a DataRequest, HistoryRequest, or ActionsRequest | Billing region of requesting account. | If `startTime` is omitted and `startDate` is in the future, the request is scheduled for 00:00. If `startTime` is omitted and `startDate` is in the past, the request is scheduled immediately. |Once | If `startDate` and `startTime` have passed, execution is scheduled immediately. Otherwise request is scheduled for `startDate` and `startTime`. | | | | | | Recurring |  If `startDate` has passed, request submission will fail. Otherwise schedule begins at `startDate` and `startTime`. If `startDate` is omitted, it defaults to the next date for the `frequency`. | | SubmitTrigger | Execute a DataRequest, HistoryRequest, ActionsRequest, or TickHistoryRequest | Billing region of requesting account. | The request is scheduled for immediate execution. |Once | The request is scheduled for immediate execution. | | BvalSnapshotTrigger | Execute a BvalSnapshotRequest| `snapshotTimeZoneName` must be a valid [IANA](https://www.iana.org/time-zones) Time Zone Name and [BVAL snapshot timezone](/#section/Features/BVAL-Evaluated-Pricing) | `snapshotTime` must be a valid BVAL [snapshot time](/#section/Features/BVAL-Evaluated-Pricing) within `snapshotTimeZoneName`| Any | If  [cutoff](/#section/Features/BVAL-Evaluated-Pricing) has passed for the `snapshotDate` and `snapshotTime` provided, the request will be rejected. If `snapshotDate` is omitted the request will be scheduled for the next available `snapshotDate`.  | | PricingSnapshotTrigger | Execute a PricingSnapshotRequest | Pricing Snapshots are only supported in the Billing region of the requesting account. | `snapshotTime` must be, 0, 15, 30, or 45 minutes past the hour.  | Any | If [cutoff](/#section/Features/Pricing-Snapshots) has passed for the `snapshotDate` and `snapshotTime` provided, the request will be rejected. If `snapshotDate` is omitted the request will be scheduled for the next available `snapshotDate`. |   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_trigger_with_http_info(body, jwt, api_version, content_type, catalog, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_trigger`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `post_trigger`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `post_trigger`")  # noqa: E501
        # verify the required parameter 'content_type' is set
        if ('content_type' not in params or
                params['content_type'] is None):
            raise ValueError("Missing the required parameter `content_type` when calling `post_trigger`")  # noqa: E501
        # verify the required parameter 'catalog' is set
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `post_trigger`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/triggers/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
