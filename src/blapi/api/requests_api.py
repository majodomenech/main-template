...
class RequestsApi(object):
    ...
    def get_field_list_by_request(self, catalog, request_name, jwt, api_version, **kwargs):  # noqa: E501
        """Get the field list for a specific Per Security request  # noqa: E501

        The field list for a specific Per Security request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_field_list_by_request(catalog, request_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_field_list_by_request_with_http_info(catalog, request_name, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_field_list_by_request_with_http_info(catalog, request_name, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_field_list_by_request_with_http_info(self, catalog, request_name, jwt, api_version, **kwargs):  # noqa: E501
        """Get the field list for a specific Per Security request  # noqa: E501

        The field list for a specific Per Security request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_field_list_by_request_with_http_info(catalog, request_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_field_list_by_request" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('catalog' not in params or
            ...
            raise ValueError("Missing the required parameter `catalog` when calling `get_field_list_by_request`")  # noqa: E501
        # verify the required parameter 'request_name' is set
        if ('request_name' not in params or
                params['request_name'] is None):
            raise ValueError("Missing the required parameter `request_name` when calling `get_field_list_by_request`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_field_list_by_request`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_field_list_by_request`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/requests/{requestName}/fieldList/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_request(self, catalog, request_name, jwt, api_version, **kwargs):  # noqa: E501
        """Get a Per Security request  # noqa: E501

        A request resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_request(catalog, request_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_request_with_http_info(catalog, request_name, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_request_with_http_info(catalog, request_name, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_request_with_http_info(self, catalog, request_name, jwt, api_version, **kwargs):  # noqa: E501
        """Get a Per Security request  # noqa: E501

        A request resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_request_with_http_info(catalog, request_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_request`")  # noqa: E501
        # verify the required parameter 'request_name' is set
        if ('request_name' not in params or
                params['request_name'] is None):
            raise ValueError("Missing the required parameter `request_name` when calling `get_request`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_request`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_request`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/requests/{requestName}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_requests(self, catalog, jwt, api_version, **kwargs):  # noqa: E501
        """List all Per Security requests  # noqa: E501

        A collection of dataset requests within a catalog  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_requests(catalog, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_requests_with_http_info(catalog, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_requests_with_http_info(catalog, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_requests_with_http_info(self, catalog, jwt, api_version, **kwargs):  # noqa: E501
        """List all Per Security requests  # noqa: E501

        A collection of dataset requests within a catalog  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_requests_with_http_info(catalog, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_requests`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_requests`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_requests`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RequestCollection',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_trigger_by_request(self, catalog, request_name, jwt, api_version, **kwargs):  # noqa: E501
        """Get the trigger for a specific Per Security request  # noqa: E501

        The trigger for a specific Per Security request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_trigger_by_request(catalog, request_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_trigger_by_request_with_http_info(catalog, request_name, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_trigger_by_request_with_http_info(catalog, request_name, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_trigger_by_request_with_http_info(self, catalog, request_name, jwt, api_version, **kwargs):  # noqa: E501
        """Get the trigger for a specific Per Security request  # noqa: E501

        The trigger for a specific Per Security request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_trigger_by_request_with_http_info(catalog, request_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_trigger_by_request" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'catalog' is set
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_trigger_by_request`")  # noqa: E501
        # verify the required parameter 'request_name' is set
        if ('request_name' not in params or
                params['request_name'] is None):
            raise ValueError("Missing the required parameter `request_name` when calling `get_trigger_by_request`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_trigger_by_request`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_trigger_by_request`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/requests/{requestName}/trigger/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_universe_by_request(self, catalog, request_name, jwt, api_version, **kwargs):  # noqa: E501
        """Get the universe for a specific Per Security request  # noqa: E501

        The universe for a specific Per Security request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_universe_by_request(catalog, request_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_universe_by_request_with_http_info(catalog, request_name, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_universe_by_request_with_http_info(catalog, request_name, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_universe_by_request_with_http_info(self, catalog, request_name, jwt, api_version, **kwargs):  # noqa: E501
        """Get the universe for a specific Per Security request  # noqa: E501

        The universe for a specific Per Security request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_universe_by_request_with_http_info(catalog, request_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_universe_by_request" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'catalog' is set
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_universe_by_request`")  # noqa: E501
        # verify the required parameter 'request_name' is set
        if ('request_name' not in params or
                params['request_name'] is None):
            raise ValueError("Missing the required parameter `request_name` when calling `get_universe_by_request`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_universe_by_request`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_universe_by_request`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/requests/{requestName}/universe/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_request(self, body, jwt, api_version, content_type, catalog, request_name, **kwargs):  # noqa: E501
        """Update a Per Security request (e.g. cancel)  # noqa: E501

        Update or disable a request.<p>The request's universe can be patched here; if, and only if, the request's universe is not a universe resource and then, can only be patched to another request level universe.</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_request(body, jwt, api_version, content_type, catalog, request_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RequestPatchPayload body: (required)
        :param str jwt: JWT(https://tools.ietf.org/html/rfc7519) Authentication token (required)
        :param str api_version: Version of the API to access. The only valid value is 2. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_request_with_http_info(body, jwt, api_version, content_type, catalog, request_name, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_request_with_http_info(body, jwt, api_version, content_type, catalog, request_name, **kwargs)  # noqa: E501
            return data

    def patch_request_with_http_info(self, body, jwt, api_version, content_type, catalog, request_name, **kwargs):  # noqa: E501
        """Update a Per Security request (e.g. cancel)  # noqa: E501

        Update or disable a request.<p>The request's universe can be patched here; if, and only if, the request's universe is not a universe resource and then, can only be patched to another request level universe.</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_request_with_http_info(body, jwt, api_version, content_type, catalog, request_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'jwt', 'api_version', 'content_type', 'catalog', 'request_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `patch_request`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `patch_request`")  # noqa: E501
        # verify the required parameter 'content_type' is set
        if ('content_type' not in params or
                params['content_type'] is None):
            raise ValueError("Missing the required parameter `content_type` when calling `patch_request`")  # noqa: E501
        # verify the required parameter 'catalog' is set
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `patch_request`")  # noqa: E501
        # verify the required parameter 'request_name' is set
        if ('request_name' not in params or
                params['request_name'] is None):
            raise ValueError("Missing the required parameter `request_name` when calling `patch_request`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/requests/{requestName}/', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_request_with_http_info(self, body, jwt, api_version, content_type, catalog, **kwargs):  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_request`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `post_request`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `post_request`")  # noqa: E501
        # verify the required parameter 'content_type' is set
        if ('content_type' not in params or
                params['content_type'] is None):
            raise ValueError("Missing the required parameter `content_type` when calling `post_request`")  # noqa: E501
        # verify the required parameter 'catalog' is set
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `post_request`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/requests/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='RequestCreatedStatus',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
