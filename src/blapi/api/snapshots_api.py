...
class SnapshotsApi(object):
    ...
    def get_snapshot(self, catalog, dataset, snapshot, jwt, api_version, **kwargs):  # noqa: E501
        """Snapshot metadata and available distributions  # noqa: E501

        A `snapshot` represents a publication of a [dataset](#tag/datasets). It contains a collection of [distributions](#tag/distributions) which are downloadable serializations of the `snapshots` as different content types.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshot(catalog, dataset, snapshot, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_snapshot_with_http_info(catalog, dataset, snapshot, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_snapshot_with_http_info(catalog, dataset, snapshot, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_snapshot_with_http_info(self, catalog, dataset, snapshot, jwt, api_version, **kwargs):  # noqa: E501
        """Snapshot metadata and available distributions  # noqa: E501

        A `snapshot` represents a publication of a [dataset](#tag/datasets). It contains a collection of [distributions](#tag/distributions) which are downloadable serializations of the `snapshots` as different content types.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshot_with_http_info(catalog, dataset, snapshot, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('catalog' not in params or
            ...
            raise ValueError("Missing the required parameter `catalog` when calling `get_snapshot`")  # noqa: E501
        # verify the required parameter 'dataset' is set
        if ('dataset' not in params or
                params['dataset'] is None):
            raise ValueError("Missing the required parameter `dataset` when calling `get_snapshot`")  # noqa: E501
        # verify the required parameter 'snapshot' is set
        if ('snapshot' not in params or
                params['snapshot'] is None):
            raise ValueError("Missing the required parameter `snapshot` when calling `get_snapshot`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_snapshot`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_snapshot`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/datasets/{dataset}/snapshots/{snapshot}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_snapshots(self, catalog, dataset, jwt, api_version, **kwargs):  # noqa: E501
        """List of available snapshots for a dataset  # noqa: E501

        `snapshots` returns a collection of [snapshot](#tag/snapshots) resources, where each [snapshot](#tag/snapshots) describes a point in the publication time series for the [dataset](#tag/datasets), and may be downloaded as a full or sample [distributions](#tag/distributions).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshots(catalog, dataset, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_snapshots_with_http_info(catalog, dataset, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_snapshots_with_http_info(catalog, dataset, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_snapshots_with_http_info(self, catalog, dataset, jwt, api_version, **kwargs):  # noqa: E501
        """List of available snapshots for a dataset  # noqa: E501

        `snapshots` returns a collection of [snapshot](#tag/snapshots) resources, where each [snapshot](#tag/snapshots) describes a point in the publication time series for the [dataset](#tag/datasets), and may be downloaded as a full or sample [distributions](#tag/distributions).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshots_with_http_info(catalog, dataset, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['catalog', 'dataset', 'jwt', 'api_version', 'page', 'start_issued', 'end_issued']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_snapshots`")  # noqa: E501
        # verify the required parameter 'dataset' is set
        if ('dataset' not in params or
                params['dataset'] is None):
            raise ValueError("Missing the required parameter `dataset` when calling `get_snapshots`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_snapshots`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_snapshots`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/datasets/{dataset}/snapshots/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
