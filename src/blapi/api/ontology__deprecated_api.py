...
class OntologyDeprecatedApi(object):
    ...
    def get_ontology(self, jwt, api_version, **kwargs):  # noqa: E501
        """Returns latest Vocabulary Documentation  # noqa: E501

        A resource with a canonical URL which provides access to a [ttl serialization of the latest snapshot of the DATA&lt;GO&gt; Ontology](https://data.bloomberg.com/catalogs/bbg/datasets/beapOntology/snapshots/20200406/distributions/beapOntology.ttl)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ontology(jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_ontology_with_http_info(jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_ontology_with_http_info(jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_ontology_with_http_info(self, jwt, api_version, **kwargs):  # noqa: E501
        """Returns latest Vocabulary Documentation  # noqa: E501

        A resource with a canonical URL which provides access to a [ttl serialization of the latest snapshot of the DATA&lt;GO&gt; Ontology](https://data.bloomberg.com/catalogs/bbg/datasets/beapOntology/snapshots/20200406/distributions/beapOntology.ttl)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ontology_with_http_info(jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_ontology`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_ontology`")  # noqa: E501
        ...
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/vnd.blp.dl.std', 'application/ld+json'])  # noqa: E501
