...
class ArchivesApi(object):
    ...
    def get_archive(self, catalog, dataset, archive_name, jwt, api_version, **kwargs):  # noqa: E501
        """A downloadable historical file  # noqa: E501

        A downloadable serialization of [archive](#tag/archive) in formats such as Parquet(http://parquet.apache.org/documentation/latest/). Please note that for content encoding of Parquet only identity (Accept-Encoding = identity) is supported, but not gzip.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_archive(catalog, dataset, archive_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_archive_with_http_info(catalog, dataset, archive_name, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_archive_with_http_info(catalog, dataset, archive_name, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_archive_with_http_info(self, catalog, dataset, archive_name, jwt, api_version, **kwargs):  # noqa: E501
        """A downloadable historical file  # noqa: E501

        A downloadable serialization of [archive](#tag/archive) in formats such as Parquet(http://parquet.apache.org/documentation/latest/). Please note that for content encoding of Parquet only identity (Accept-Encoding = identity) is supported, but not gzip.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_archive_with_http_info(catalog, dataset, archive_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('catalog' not in params or
            ...
            raise ValueError("Missing the required parameter `catalog` when calling `get_archive`")  # noqa: E501
        # verify the required parameter 'dataset' is set
        if ('dataset' not in params or
                params['dataset'] is None):
            raise ValueError("Missing the required parameter `dataset` when calling `get_archive`")  # noqa: E501
        # verify the required parameter 'archive_name' is set
        if ('archive_name' not in params or
                params['archive_name'] is None):
            raise ValueError("Missing the required parameter `archive_name` when calling `get_archive`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_archive`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_archive`")  # noqa: E501
        ...
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/parquet', 'application/ld+json'])  # noqa: E501

        # Authentication setting
        auth_settings = []  # noqa: E501

        return self.api_client.call_api(
            '/catalogs/{catalog}/datasets/{dataset}/archives/{archiveName}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_archives(self, catalog, dataset, jwt, api_version, **kwargs):  # noqa: E501
        """List of available archives for a dataset  # noqa: E501

        `archives` returns a collection of [archive](#tag/archives) resources, where each [archive](#tag/archives) describes aggregated historical data for the [dataset](#tag/datasets), and a downloadable link.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_archives(catalog, dataset, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        :param str jwt: JWT(https://tools.ietf.org/html/rfc7519) Authentication token (required)
        :param str api_version: Version of the API to access. The only valid value is 2. (required)
        :param ArchiveStatus status: The status by which to filter the returned Archives. If unspecified Archives of all statuses are returned.
        :param date start_snapshot_date: The start of the date range within which to filter Archive snapshots. The filter is an inclusive match between Archive startSnpashotDate and endSnpashotDate. If unspecified, there is no lower bound on the snapshot date range. (e.g. `2020-11-15`).
        :param date end_snapshot_date: The end of the date range within which to filter Archive snapshots. The filter is an inclusive match between Archive startSnapshotDate and endSnapshotDate. If unspecified, there is no upper bound on the snapshot date range. (e.g. `2020-11-17`).
        :param str start_issued: snapshot issued date filter, e.g. 2019-05-31. Snapshots issued on or after the given filter will be returned.
        :param str end_issued: snapshot issued date filter, e.g. 2019-12-31. Snapshots issued on or before the given filter will be returned.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_archives_with_http_info(catalog, dataset, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_archives_with_http_info(catalog, dataset, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_archives_with_http_info(self, catalog, dataset, jwt, api_version, **kwargs):  # noqa: E501
        """List of available archives for a dataset  # noqa: E501

        `archives` returns a collection of [archive](#tag/archives) resources, where each [archive](#tag/archives) describes aggregated historical data for the [dataset](#tag/datasets), and a downloadable link.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_archives_with_http_info(catalog, dataset, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['catalog', 'dataset', 'jwt', 'api_version', 'status', 'start_snapshot_date', 'end_snapshot_date', 'start_issued', 'end_issued', 'page', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_archives`")  # noqa: E501
        # verify the required parameter 'dataset' is set
        if ('dataset' not in params or
                params['dataset'] is None):
            raise ValueError("Missing the required parameter `dataset` when calling `get_archives`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_archives`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_archives`")  # noqa: E501
        ...
        if 'start_snapshot_date' in params:
            query_params.append(('startSnapshotDate', params['start_snapshot_date']))  # noqa: E501
        if 'end_snapshot_date' in params:
            query_params.append(('endSnapshotDate', params['end_snapshot_date']))  # noqa: E501
        if 'start_issued' in params:
            query_params.append(('startIssued', params['start_issued']))  # noqa: E501
        if 'end_issued' in params:
            query_params.append(('endIssued', params['end_issued']))  # noqa: E501
        if 'page' in params:
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/datasets/{dataset}/archives/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
