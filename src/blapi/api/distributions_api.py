...
class DistributionsApi(object):
    ...
    def get_distribution(self, catalog, dataset, snapshot, distribution_name, jwt, api_version, **kwargs):  # noqa: E501
        """A downloadable distribution of a snapshot  # noqa: E501

        A downloadable serialization of [snapshot](#tag/snapshots) as a standard [media type](https://www.w3.org/TR/vocab-dcat-2/#Property:distribution_media_type) (content type).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_distribution(catalog, dataset, snapshot, distribution_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        :param str range: For file download requests this can be used to specify a specific part of the file to be returned. Bytes is the only supported unit. DL REST API requires that `Accept-Encoding: gzip` is specified for range requests.
        :return: str
        ...
        if kwargs.get('async_req'):
            return self.get_distribution_with_http_info(catalog, dataset, snapshot, distribution_name, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_distribution_with_http_info(catalog, dataset, snapshot, distribution_name, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_distribution_with_http_info(self, catalog, dataset, snapshot, distribution_name, jwt, api_version, **kwargs):  # noqa: E501
        """A downloadable distribution of a snapshot  # noqa: E501

        A downloadable serialization of [snapshot](#tag/snapshots) as a standard [media type](https://www.w3.org/TR/vocab-dcat-2/#Property:distribution_media_type) (content type).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_distribution_with_http_info(catalog, dataset, snapshot, distribution_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['catalog', 'dataset', 'snapshot', 'distribution_name', 'jwt', 'api_version', 'range']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_distribution" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('catalog' not in params or
            ...
            raise ValueError("Missing the required parameter `catalog` when calling `get_distribution`")  # noqa: E501
        # verify the required parameter 'dataset' is set
        if ('dataset' not in params or
                params['dataset'] is None):
            raise ValueError("Missing the required parameter `dataset` when calling `get_distribution`")  # noqa: E501
        # verify the required parameter 'snapshot' is set
        if ('snapshot' not in params or
                params['snapshot'] is None):
            raise ValueError("Missing the required parameter `snapshot` when calling `get_distribution`")  # noqa: E501
        ...
        if ('distribution_name' not in params or
            ...
            raise ValueError("Missing the required parameter `distribution_name` when calling `get_distribution`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_distribution`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_distribution`")  # noqa: E501
        ...
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/vnd.blp.dl.std', 'text/csv', 'application/ld+json'])  # noqa: E501

        # Authentication setting
        auth_settings = []  # noqa: E501

        return self.api_client.call_api(
            '/catalogs/{catalog}/datasets/{dataset}/snapshots/{snapshot}/distributions/{distributionName}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_distributions(self, catalog, dataset, snapshot, jwt, api_version, **kwargs):  # noqa: E501
        """List of distributions of a snapshot  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_distributions(catalog, dataset, snapshot, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        :param str jwt: JWT(https://tools.ietf.org/html/rfc7519) Authentication token (required)
        :param str api_version: Version of the API to access. The only valid value is 2. (required)
        :param list[DistributionType] type: The type of distributions to be returned
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_distributions_with_http_info(catalog, dataset, snapshot, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_distributions_with_http_info(catalog, dataset, snapshot, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_distributions_with_http_info(self, catalog, dataset, snapshot, jwt, api_version, **kwargs):  # noqa: E501
        """List of distributions of a snapshot  # noqa: E501

        A collection of downloadable [distribution](#tag/distribution) resources. Each [distribution](#tag/distributions) in the collection serializes a [snapshot](#tag/snapshots) as a different [media type](https://www.w3.org/TR/vocab-dcat-2/#Property:distribution_media_type) (content type), and is represented as a structure: the downloadable [distribution] itself; if it is a sample of the [snapshot](#tag/snapshots) (samples are accessible to all users); and if it is accessible with the requesting credentials.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_distributions_with_http_info(catalog, dataset, snapshot, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['catalog', 'dataset', 'snapshot', 'jwt', 'api_version', 'type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_distributions" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'catalog' is set
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_distributions`")  # noqa: E501
        # verify the required parameter 'dataset' is set
        if ('dataset' not in params or
                params['dataset'] is None):
            raise ValueError("Missing the required parameter `dataset` when calling `get_distributions`")  # noqa: E501
        # verify the required parameter 'snapshot' is set
        if ('snapshot' not in params or
                params['snapshot'] is None):
            raise ValueError("Missing the required parameter `snapshot` when calling `get_distributions`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_distributions`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_distributions`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/datasets/{dataset}/snapshots/{snapshot}/distributions/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='Distributions',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
