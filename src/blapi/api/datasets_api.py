...
class DatasetsApi(object):
    ...
    def get_dataset(self, catalog, dataset, jwt, api_version, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_dataset_with_http_info(catalog, dataset, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_dataset_with_http_info(catalog, dataset, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_dataset_with_http_info(self, catalog, dataset, jwt, api_version, **kwargs):  # noqa: E501
        """Dataset definition and available snapshot resources  # noqa: E501

        ## Bulk Dataset In the [Bloomberg Catalog](#tag/catalogs), a `dataset` is a class of publication, containing a time series of [snapshots](#tag/snapshots). Each [snapshot](#tag/snapshots) is a point in the time series, which represents a single publication of the `dataset`.  ## Custom Dataset In an [Account Catalog](#tag/catalogs), each `dataset` represents a response to a user defined [request](#/tags/request) in that [catalog](#tag/catalogs). The custom `dataset` and the [snapshots](#tag/snapshots) container within it are created at the moment a [request](#tag/requests) is created. Individual [snapshot](#tag/snapshots) resources are added to the [snapshots](#tag/snapshots) container each time the [request](#tags/requests) is executed.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_dataset_with_http_info(catalog, dataset, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['catalog', 'dataset', 'jwt', 'api_version']  # noqa: E501
        ...
        if ('catalog' not in params or
            ...
            raise ValueError("Missing the required parameter `catalog` when calling `get_dataset`")  # noqa: E501
        ...
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_dataset`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_dataset`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/{catalog}/datasets/{dataset}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_datasets(self, catalog, jwt, api_version, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_datasets_with_http_info(catalog, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_datasets_with_http_info(catalog, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_datasets_with_http_info(self, catalog, jwt, api_version, **kwargs):  # noqa: E501
        """Datasets in this catalog  # noqa: E501

        ## Bloomberg Catalog (Bulk Datasets) The [Bloomberg Catalog](#tag/catalogs) contains a collection of Bulk [datasets](#tag/datasets) defined and offered by Bloomberg Data License.  Access rights to Bulk `datasets` are determined through active subscriptions for the DL account that issued the requestor's credentials. Sample data is accessible for all Bulk `datasets`.  The `subscribed` property (which can be used as a query parameter) indicates if the requesting credentials are privileged to access non-sample [snapshots](#tag/snapshots) of each dataset.  ## Account Catalog (Custom Datasets) An [Account Catalog](#tag/catalogs) contains a collection of Bloomberg Data License responses ([datasets](#tag/datasets)) to the user defined [requests](#/tags/requests) that have been submitted to the same [catalog](#tag/catalogs).  Custom `datasets` are accessible to requestors using any credential issued by the DL account that submitted the [request](#tag/requests)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_datasets_with_http_info(catalog, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['catalog', 'jwt', 'api_version', 'page', 'sort', 'q', 'subscribed', 'module_level1', 'module_level2', 'module_level3', 'universe_label', 'universe_subset_label', 'publisher']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('catalog' not in params or
                params['catalog'] is None):
            raise ValueError("Missing the required parameter `catalog` when calling `get_datasets`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_datasets`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_datasets`")  # noqa: E501
