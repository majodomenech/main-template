...
class PublishersDeprecatedApi(object):
    ...
    def catalogs_bbg_publishers_get(self, jwt, api_version, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.catalogs_bbg_publishers_get_with_http_info(jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.catalogs_bbg_publishers_get_with_http_info(jwt, api_version, **kwargs)  # noqa: E501
            return data

    def catalogs_bbg_publishers_get_with_http_info(self, jwt, api_version, **kwargs):  # noqa: E501
        """A collection of Publisher resources  # noqa: E501

        A collection of [(Dublin Core)](http://dublincore.org/documents/dcmi-terms/#terms-publisher) `Publishers`, which are used as a primary means of classifying each [Bulk Dataset](#tag/datasets) in the [Bloomberg Catalog](#tag/catalogs). `Publishers` are provided to support the exploration and discovery of [Bulk Datasets](#tag/datasets). Each [publisher](#tag/publishers) is annotated with a dataset count and facetted search URL to list the [datasets](#tag/datasets) offered by that [publisher](#tag/publishers).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.catalogs_bbg_publishers_get_with_http_info(jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['jwt', 'api_version', 'page', 'sort', 'q']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method catalogs_bbg_publishers_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `catalogs_bbg_publishers_get`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `catalogs_bbg_publishers_get`")  # noqa: E501
        ...
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json-ld', 'application/ld+json'])  # noqa: E501

        # Authentication setting
        auth_settings = []  # noqa: E501

        return self.api_client.call_api(
            '/catalogs/bbg/publishers/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def catalogs_bbg_publishers_publisher_name_get(self, publisher_name, jwt, api_version, **kwargs):  # noqa: E501
        """Metadata for a publisher  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.catalogs_bbg_publishers_publisher_name_get(publisher_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.catalogs_bbg_publishers_publisher_name_get_with_http_info(publisher_name, jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.catalogs_bbg_publishers_publisher_name_get_with_http_info(publisher_name, jwt, api_version, **kwargs)  # noqa: E501
            return data

    def catalogs_bbg_publishers_publisher_name_get_with_http_info(self, publisher_name, jwt, api_version, **kwargs):  # noqa: E501
        """Metadata for a publisher  # noqa: E501

        A single [(Dublin Core)](http://dublincore.org/documents/dcmi-terms/#terms-publisher) `Publisher`, which exists to classify a group of [Bulk Datasets](#tag/datasets) in the [Bloomberg Catalog](#tag/catalogs). Each [publisher](#tag/publishers) is annotated with a dataset count and facetted search URL to list the [datasets](#tag/datasets) offered by that [publisher](#tag/publishers).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.catalogs_bbg_publishers_publisher_name_get_with_http_info(publisher_name, jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method catalogs_bbg_publishers_publisher_name_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('publisher_name' not in params or
            ...
            raise ValueError("Missing the required parameter `publisher_name` when calling `catalogs_bbg_publishers_publisher_name_get`")  # noqa: E501
        # verify the required parameter 'jwt' is set
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `catalogs_bbg_publishers_publisher_name_get`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `catalogs_bbg_publishers_publisher_name_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/catalogs/bbg/publishers/{publisherName}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
