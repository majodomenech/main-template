...
class EntrypointApi(object):
    ...
    def get_root(self, jwt, api_version, **kwargs):  # noqa: E501
        """Entry point  # noqa: E501

        The entryPoint lists available top-level resources. All available resources are organized within a container called  `catalogs`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_root(jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_root_with_http_info(jwt, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_root_with_http_info(jwt, api_version, **kwargs)  # noqa: E501
            return data

    def get_root_with_http_info(self, jwt, api_version, **kwargs):  # noqa: E501
        """Entry point  # noqa: E501

        The entryPoint lists available top-level resources. All available resources are organized within a container called  `catalogs`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_root_with_http_info(jwt, api_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('jwt' not in params or
                params['jwt'] is None):
            raise ValueError("Missing the required parameter `jwt` when calling `get_root`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `get_root`")  # noqa: E501
