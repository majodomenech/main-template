...
```
cd existing_repo
git remote add origin https://gitlab.com/sycdev/main-template.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sycdev/main-template/-/settings/integrations)
